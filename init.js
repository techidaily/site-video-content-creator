...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Ava';
const subSiteKeywords = `smart video creator, smart video editor, smart ai video` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = '6c7be27196a0481ba5346d1b68048cba'; // 替换为你的API密钥
